 ...
 */
final class Version20260209125254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournament ADD CONSTRAINT FK_BD5FB8D97E3C61F9 FOREIGN KEY (owner_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BD5FB8D97E3C61F9 ON tournament');
